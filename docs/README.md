...
- `specs/issue-intake.md` — T015 deterministic intake classifier spec
...
- `specs/t005-validation-report.md` — T005 kernel validation summary
...
- `specs/t008-validation-report.md` — T008 event inbox validation summary
- `specs/t014-validation-report.md` — T014 runtime mode validation summary
- `specs/t015-validation-report.md` — T015 intake classifier validation summary
- `specs/t016-validation-report.md` — T016 Plan Spec DSL validation summary
